...
private[iteratee] case class NoLeftovers[F[_]: Applicative, E, A](value: A) extends BaseDone[F, E, A] {
...
private[iteratee] case class WithLeftovers[F[_]: Applicative, E, A](value: A, remaining: Input[E])
