...
package modules {
  ...
  trait EvalModule
      extends Module[Eval]
      with EnumerateeModule[Eval]
      with EnumeratorModule[Eval]
      with IterateeModule[Eval] {
  ...
  trait IdModule extends Module[Id] with EnumerateeModule[Id] with EnumeratorModule[Id] with IterateeModule[Id] {
    final type M[f[_]] = Monad[f]
  ...
  trait OptionModule
      extends Module[Option]
      with EnumerateeModule[Option]
      with EnumeratorModule[Option]
      with IterateeModule[Option] {
    final type M[f[_]] = Monad[f]
